...
class salesClass:
    def __init__(self,root):
        ...
        lbl_invoice=Label(self.root,text="Bill Holder :",font=("times new roman",15),bg="white").place(x=50,y=100) 
        ...
        #=========Image============
        self.bill_photo=Image.open("Images/cat3.jpeg")
...
#==========================================================================
    ...
    def search(self):
        if self.var_invoice.get()=="":
            messagebox.showerror("Error","Invoice no. should be rrquired",parent=self.root)
        else:
